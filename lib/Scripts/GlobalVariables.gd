...
const LOOT_POOL_ACTIVE = [
	preload("res://ActiveItems/IronSkin.tscn"), preload("res://ActiveItems/BrokenClock.tscn"),
	preload("res://ActiveItems/DevilDeal.tscn"), preload("res://ActiveItems/SpiritCamera.tscn"),
	preload("res://ActiveItems/Repulsor.tscn")]
const LOOT_POOL_WHITE = [
	preload("res://Items/TwoPercent.tscn"), preload("res://Items/Coffee.tscn"),
...
const LOOT_POOL_GREEN = [
	preload("res://Items/PainPills.tscn"),preload("res://Items/TowerShield.tscn"),
...
const LOOT_POOL_BLUE = [
	preload("res://Items/MarineHelmet.tscn"),preload("res://Items/PhoneBook.tscn"),
	preload("res://Items/Gloves.tscn"), preload("res://Items/ItchyFinger.tscn")]
const LOOT_POOL_PURPLE = [
	preload("res://Items/ElixirOfLife.tscn"),preload("res://Items/FullMetalJacket.tscn"),
...
const LOOT_POOL_ORANGE = [
	preload("res://Items/ChiliPepper.tscn"),preload("res://Items/BottleOfRage.tscn"),
